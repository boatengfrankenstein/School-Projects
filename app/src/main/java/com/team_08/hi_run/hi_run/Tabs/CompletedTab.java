...
public class CompletedTab extends ListFragment {

    private ArrayList<Run> mjobs;
    private final String TAG = "CompletedTab";

    @Override
    public void onCreate( Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        mjobs = LoginActivity.getmComplete();
        Log.d("CompletedTab", String.valueOf(mjobs.size()));
