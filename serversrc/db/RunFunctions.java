...
public class RunFunctions {
	 ...
	 * @param newRun
	 */
	public static void AppAddRun(Run newRun){
	 ...
	 * @param user
	 */
	public static void AppUpdateRun(Run run){
		sessionId = UserFunctions.getSessionId();
		sessionSalt = UserFunctions.getSessionSalt();
		ws = UserFunctions.getWS();
	 ...
	 * @param clientId
	 */
	public static void ClientPOV(int clientId) {
		sessionId = UserFunctions.getSessionId();
		sessionSalt = UserFunctions.getSessionSalt();
		ws = UserFunctions.getWS();
	 ...
	 * @param runnerId
	 */
	public static void RunnerPOV(int runnerId) {
		sessionId = UserFunctions.getSessionId();
		sessionSalt = UserFunctions.getSessionSalt();
		ws = UserFunctions.getWS();
	 ...
	 * @param userId
	 */
	public static void BothPOV(int userId) {
		sessionId = UserFunctions.getSessionId();
		sessionSalt = UserFunctions.getSessionSalt();
		ws = UserFunctions.getWS();
	...
	public static void AdminPOV(int userId) {
		sessionId = UserFunctions.getSessionId();
		sessionSalt = UserFunctions.getSessionSalt();
		ws = UserFunctions.getWS();
	...
	public static String getVersion(Run run){
		sessionId = UserFunctions.getSessionId();
		sessionSalt = UserFunctions.getSessionSalt();
		ws = UserFunctions.getWS();
