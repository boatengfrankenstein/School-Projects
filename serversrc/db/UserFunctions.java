...
public class UserFunctions {
	...
	public static void WSLogin(InputStream input){ //uses the login web service
	...
	public static void WSHello(){ //uses the hello web service
	 ...
	 * @return
	 */
	public static User AppLogin(String username, String password, InputStream input){
		WSLogin(input);
	 ...
	 * @param newUser
	 */
	public static void AppAddUser(User newUser, InputStream input){
		WSLogin(input);
	 ...
	 * @param user
	 */
	public static void AppUpdateUser(User user){
	...
	public static User getRunner(int runnerId){
		JSONArray arr = new JSONArray();
		JSONObject obj3 = new JSONObject(); //run sql object
		obj3.put("action", "run_sql");
		arr.put(obj3);
	...
	public static void AppVerifyUser(User user){
